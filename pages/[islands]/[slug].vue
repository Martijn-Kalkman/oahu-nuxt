<template>
  <div class="">
      ...
      <div data-aos="fade-right" data-aos-duration="1500" class="container mx-auto">
        ...
        <div class="flex flex-col xl:flex-row gap-8">
          <div class="w-full lg:h-[900px] md:h-[600px] h-[400px]">
            <iframe class="w-full h-2/3 mb-4" src="/oahutoursvideo.mp4" frameborder="0"></iframe>

            <!-- <video src="/oahutoursvideo.mp4" autoplay class="mb-6"></video> -->
            <swiper :spaceBetween="-55" :centeredSlides="true" :slidesPerView="1.3" :pagination="{
              clickable: true,
            }" :loop="true" :modules="modules" class="mySwiper h-[200px] lg:w-[800px] md:w-[650px] w-[300px]">
              <swiper-slide class="relative transform transition-all duration-300 scale-90 swiper-slide-prev-next">
                <img src="/aboutimg.png" alt="Slide 1" class="w-full object-cover shadow-lg" />
              </swiper-slide>
              <swiper-slide class="relative transform transition-all duration-300 scale-90 swiper-slide-prev-next">
                <img src="/aboutimg.png" alt="Slide 2" class="w-full h-full object-cover shadow-lg" />
              </swiper-slide>
              <swiper-slide class="relative transform transition-all duration-300 scale-90 swiper-slide-prev-next">
                <img src="/aboutimg.png" alt="Slide 3" class="w-full h-full object-cover shadow-lg" />
              </swiper-slide>
              <swiper-slide class="relative transform transition-all duration-300 scale-90 swiper-slide-prev-next">
                <img src="/aboutimg.png" alt="Slide 4" class="w-full h-full object-cover shadow-lg" />
              </swiper-slide>
            </swiper>
          </div>
          <div class="w-full justify-center">
            <div class="py-10 container mx-auto">
              <div v-for="(card, index) in cards.slice(0, 1)" :key="card.slug" class="bg-white shadow-xl">
                <div :style="{ backgroundImage: `url(${card.headerImage})` }"
                ...
                <div class="p-6 Montserratreg">
                  ...
                  <div class="grid grid-cols-12">
                    <div class="col-span-6">
                      <p class="line-through decoration-red-500 decoration-2 text-xl">${{ card.price }}</p>
                    ...
                    <div class="col-span-6">
                      ...
                      <div class="Aileron font-bold ml-4">
                        <a href="tel:8085623222" class="flex flex-row gap-4">
                          <img draggable="false" src="/phoneblack.png" alt="phone icon" />(808) 562-3222</a>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <div class="py-10 container mx-auto">
      <div class="grid xl:grid-cols-3 lg:grid-cols-2 grid-cols-1 flex-wrap w-full justify-between gap-6 mx-auto">
        <div v-for="(card, index) in cards" :key="card.slug" class="w-full bg-white shadow-xl col-span-1">
          <div :style="{ backgroundImage: `url(${card.headerImage})` }"
